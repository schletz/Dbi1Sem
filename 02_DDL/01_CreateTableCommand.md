...
> IDENTITY Spalte mittels INSERT anzugeben. Durch das Statement
> *SET IDENTITY_INSERT Tablename ON* kann dies aktiviert werden.
...
-- AppUser ist ein reserviertes Wort, deswegen verwenden wir
-- in SQL Server []
CREATE TABLE Rating (
	Id           INTEGER IDENTITY(1,1) PRIMARY KEY,
	SchoolNr     INTEGER  NOT NULL,
...
CREATE TABLE RatingCriteria (
	...
	Name      VARCHAR2(100) NOT NULL UNIQUE         -- Der Name darf nicht mehrmals vorkommen.
);
